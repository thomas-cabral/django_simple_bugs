...
urlpatterns = patterns('',
    ...
    url(r'^requirement/(?P<pk>\d+)/(?P<slug>[0-9A-Za-z-_.//]+)/update/$', views.RequirementUpdate.as_view(), name='requirement_update'),
    url(r'^requirement/(?P<pk>\d+)/(?P<slug>[0-9A-Za-z-_.//]+)/cases/$', views.RequirementCases.as_view(), name='requirement_cases'),
    url(r'^requirement/(?P<pk>\d+)/(?P<slug>[0-9A-Za-z-_.//]+)/$', views.RequirementDetail.as_view(), name='requirement_detail'),
