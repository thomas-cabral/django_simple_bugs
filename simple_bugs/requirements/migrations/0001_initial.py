...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoricalRequirement'
        db.create_table(u'requirements_historicalrequirement', (
        ...
        db.send_create_signal(u'requirements', ['HistoricalRequirement'])
        ...
        db.create_table(u'requirements_requirement', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requirements_user', to=orm['auth.User'])),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='requirement_changed_by', null=True, to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requirement_project', to=orm['projects.Project'])),
        ))
        db.send_create_signal(u'requirements', ['Requirement'])

        # Adding M2M table for field working_on on 'Requirement'
        m2m_table_name = db.shorten_name(u'requirements_requirement_working_on')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('requirement', models.ForeignKey(orm[u'requirements.requirement'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting model 'HistoricalRequirement'
        db.delete_table(u'requirements_historicalrequirement')

        # Deleting model 'Requirement'
        db.delete_table(u'requirements_requirement')

        # Removing M2M table for field working_on on 'Requirement'
        db.delete_table(db.shorten_name(u'requirements_requirement_working_on'))
    ...
    models = {
        ...
        u'requirements.historicalrequirement': {
