...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Case.time_estimate'
        db.delete_column(u'simple_bugs_case', 'time_estimate')

        # Deleting field 'HistoricalCase.time_estimate'
        db.delete_column(u'simple_bugs_historicalcase', 'time_estimate')


    def backwards(self, orm):
        # Adding field 'Case.time_estimate'
        db.add_column(u'simple_bugs_case', 'time_estimate',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'HistoricalCase.time_estimate'
        db.add_column(u'simple_bugs_historicalcase', 'time_estimate',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)
