...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Bug.requirement'
        db.alter_column(u'simple_bugs_bug', 'requirement_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['simple_bugs.Requirement'], unique=True))
    ...
    models = {
        ...
        u'simple_bugs.bug': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'requirement': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['simple_bugs.Requirement']", 'unique': 'True', 'null': 'True'}),
