...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Case'
        db.create_table(u'simple_bugs_case', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=155)),
        ...
        db.send_create_signal(u'simple_bugs', ['Case'])


    def backwards(self, orm):
        # Deleting model 'Case'
        db.delete_table(u'simple_bugs_case')
