...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'simple_bugs_historicalrequirement', (
        ...
        db.send_create_signal(u'simple_bugs', ['HistoricalRequirement'])

        # Adding model 'HistoricalCase'
        db.create_table(u'simple_bugs_historicalcase', (
            (u'id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('time_estimate', self.gf('django.db.models.fields.TimeField')(null=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            (u'user_id', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True)),
        ...
        db.send_create_signal(u'simple_bugs', ['HistoricalCase'])


    def backwards(self, orm):
        # Deleting model 'HistoricalRequirement'
        db.delete_table(u'simple_bugs_historicalrequirement')

        # Deleting model 'HistoricalCase'
        db.delete_table(u'simple_bugs_historicalcase')
