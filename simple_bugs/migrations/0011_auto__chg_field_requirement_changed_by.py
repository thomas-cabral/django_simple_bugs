...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Requirement.changed_by'
        db.alter_column(u'simple_bugs_requirement', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Requirement.changed_by'
        db.alter_column(u'simple_bugs_requirement', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
