...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'simple_bugs_estimate')


    def backwards(self, orm):
        # Adding model 'Estimate'
        db.create_table(u'simple_bugs_estimate', (
            ('case', self.gf('django.db.models.fields.related.ForeignKey')(related_name='case_estimate', to=orm['simple_bugs.Case'])),
            ('total_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='estimate_user', to=orm['auth.User'])),
            ('estimate', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=55)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'simple_bugs', ['Estimate'])
