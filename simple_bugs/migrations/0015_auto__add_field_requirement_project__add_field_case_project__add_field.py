...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'simple_bugs_requirement', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='requirement_project', to=orm['simple_bugs.Project']),
                      keep_default=False)

        # Adding field 'Case.project'
        db.add_column(u'simple_bugs_case', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='case_project', to=orm['simple_bugs.Project']),
                      keep_default=False)

        # Adding field 'HistoricalRequirement.project_id'
        db.add_column(u'simple_bugs_historicalrequirement', u'project_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalCase.project_id'
        db.add_column(u'simple_bugs_historicalcase', u'project_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'simple_bugs_requirement', 'project_id')

        # Deleting field 'Case.project'
        db.delete_column(u'simple_bugs_case', 'project_id')

        # Deleting field 'HistoricalRequirement.project_id'
        db.delete_column(u'simple_bugs_historicalrequirement', u'project_id')

        # Deleting field 'HistoricalCase.project_id'
        db.delete_column(u'simple_bugs_historicalcase', u'project_id')
    ...
    models = {
        ...
        u'simple_bugs.case': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'case_project'", 'to': u"orm['simple_bugs.Project']"}),
        ...
        u'simple_bugs.estimate': {
            ...
            'estimate': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'total_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'simple_bugs.requirement': {
            ...
            'detail': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requirement_project'", 'to': u"orm['simple_bugs.Project']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '55'}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
